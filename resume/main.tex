...
\begin{center}
    ...
    $|$
    \faAt \hspace{.5pt} \href{mailto:sinagadarvin@gmail.com}{mymail}
    $|$
    \faLinkedinSquare \hspace{.5pt} \href{https://www.linkedin.com/in/elianriu}{LinkedIn}
    $|$
    \faGithub \hspace{.5pt} \href{https://github.com/elianriu}{GitHub}
    $|$
...
\section{Work Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Senior Associate, Backend}{Feb 2025 \textbf{--} Present}
        \resumeItemListStart
        ...
        \resumeSubheading
        {}{}
      {Associate, Backend}{Nov 2023 \textbf{--} Feb 2025}
        \resumeItemListStart
            \resumeItem{Promoted to Senior Associate}
        ...
        \resumeSubheading
        {}{}
      {Associate, Frontend} {1.7 years(May 2022 \textbf{--} Nov 2023)}
        \resumeItemListStart
    ...
    {Assosiate Software Engineer,Frontend}{7 Month(May 2022 \textbf{--} 31 Dec 2022)}
      \resumeItemListStart
          ...
          \resumeItem{DBS Bank converted me as a permanent employee}
      \resumeItemListEnd
    \resumeSubheading
...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeEducationHeading
      ...
      {Computer Science;   \textbf{GPA: 3.48/4.0}}{}
      { }{ }
        % \resumeItemListStart
